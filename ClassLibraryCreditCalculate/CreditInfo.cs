    ...
    { 
        public List<Payments> Calculate(dynamic bankCreditData)
        {
            ...
            try
            {
                ...
                double rationAnnuity = RatioAnnuity(periodInterestRate, countPeriod); //Коэффициент аннуитета
                double periodPayments = Math.Round(rationAnnuity * creditAmount, 2); //Месячный платеж или 10 или 15 дней
        ...
        /// <returns></returns>
        private double RatioAnnuity(double periodInterestRate, double countPeriod) => periodInterestRate + (periodInterestRate /           
